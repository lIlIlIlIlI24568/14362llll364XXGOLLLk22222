...
local Button = xgo1Tab:MakeButton("Button", {	["Title"]  ="不再",     ["Content"] ="音乐id:1846458016",    local sound = Instance.new("Sound")    sound.SoundId = "rbxassetid://1846458016"    sound.Parent = game.Workspace    sound:Play()    end})
